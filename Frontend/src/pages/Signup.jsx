        ...
        <div>
            <div className="flex flex-col gap-2 mt-4 w-full md:w-3/7 mx-auto sm:border border-gray-400 p-4 rounded-md sm:shadow-md bg-white">
                ...
                <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-2 mt-4">
                    ...
                    <input type="text" id="username" placeholder="Enter your Name" required className="border border-gray-400 w-full h-10 px-2 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-600 source-sans-3"/>
                    <label className="source-sans-3 text-gray-800" htmlFor="email">Email</label>
                    <input type="email" id="email" placeholder="Enter your email" required className="border border-gray-400 w-full h-10 px-2 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-600 source-sans-3"/>
                    <label className="source-sans-3 text-gray-800" htmlFor="password">Password</label>
                    <input type="password" id="password" placeholder="Enter your password" required className="border border-gray-400 w-full h-10 px-2 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-600 source-sans-3"/>
                    <label className="source-sans-3 text-gray-800" htmlFor="confirm-password">Confirm Password</label>
                    <input type="password" id="confirm-password" placeholder="Confirm your password" required className="border border-gray-400 w-full h-10 px-2 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-600 source-sans-3"/>
                    {/* remember me */}
                    ...
                    <button onClick={()=>navigate("/login")} type="submit" className="bg-gray-500 text-white py-2 px-4 rounded-md mt-4 cursor-pointer hover:bg-gray-600 text-xl source-sans-3">Sign Up</button>
