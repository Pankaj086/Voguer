...
const Collection = () => {
    ...
    return (
        <div>
            ...
            <div className="flex justify-between relative z-0 gap-20">
                ...
                {/* sorting section */}
                <div onClick={()=>{setSortDropDown(!sortDropDown)}} className="z-10 absolute -top-10 sm:-top-12 right-0 min-w-1/8 rounded-md border border-gray-300 bg-white">
